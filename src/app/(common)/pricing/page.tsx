...
export const metadata = {
  title: "Pricing | CyberBeid",
  description:
    "CyberBeid offers flexible, value-driven pricing tailored to your unique project needs. We prioritize transparency, quality, and results—without locking you into one-size-fits-all packages.",
};
  ...
  return (
    <main>
      <PageHeaderSection
        ...
        description="At CyberBeid, we don’t believe in one-size-fits-all pricing. Every business is unique, and so are its digital needs. Whether you're launching a startup MVP or scaling a full enterprise platform, our pricing adapts to your goals, scope, and timeline."
...
<div class="space-y-6">
  <div>
    ...
    <p>
      At CyberBeid, we do pricing differently. Forget bloated packages
  ...
  <div>
    ...
    <p>
      With CyberBeid, you’re in control — no surprise fees, no fluff,
