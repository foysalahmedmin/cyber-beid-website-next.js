...
<section class="space-y-12">
  <article>
    ...
    <p>
      As Co-Founder and Project Manager at CyberBeid, Foysal Ahmed combines technical expertise with strategic vision to lead digital transformation initiatives. 
      Under his stewardship, CyberBeid has delivered 50+ projects with a 98% client satisfaction rate while maintaining ISO 27001 compliance across all operations.
    </p>
  ...
  <article>
    ...
    <div class="values-grid">
      <div>
        ...
        <p>Architected CyberBeid's Zero-Trust Security Framework adopted by healthcare and financial institutions</p>
      </div>
      <div>
  ...
  <div>
    ...
    <p>
      ...
      <a href="/leaderships/foysalahmedmin">CyberBeid Portfolio</a>
    </p>
  </div>
</section>
    `,
