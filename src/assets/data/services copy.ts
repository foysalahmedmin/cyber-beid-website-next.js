...
export type TService = {
  ...
  link: string;
  details: {
    thumbnail: string; // Relevant Image from the internet (Note: Image should not any person face.)
    title: string;
        ...
        <div>
          ...
          <div>
            ...
            <ul>
              ...
              <!-- <li>
                  <strong>CI/CD Implementation:</strong> Automated deployment pipelines
          ...
          <div>
            ...
            <ul>
              ...
              <!-- <li>
                <strong>Cloud Deployment:</strong> AWS, Google Cloud, and Azure
  ...
  },
  {
    ...
    details: {
      ...
      links: [
        {
          text: "Get Free Quote",
          url: "/quote/data-entry",
        },
        {
          text: "View Portfolio",
          url: "/portfolio/data-entry",
        },
      ],
    },
    points: {
      thumbnail:
        "https://images.unsplash.com/photo-1454165804606-c3d57bc86b40?w=1000&h=600&fit=crop",
      list: [
        {
          ...
          links: [
            {
              text: "Learn More",
              url: "/services/data-entry/management",
            },
          ],
        },
        {
      ...
      links: [
        {
          ...
          url: "/consultation/back-office",
        },
        {
          text: "Service Packages",
          url: "/packages/back-office",
        },
      ],
    },
    points: {
      ...
      list: [
        ...
        },
        {
          ...
          links: [
            {
              text: "Moderation Solutions",
              url: "/services/content-moderation",
            },
          ],
        },
        {
          ...
          links: [
            {
              text: "Admin Services",
              url: "/services/administrative-support",
            },
          ],
        },
        {
